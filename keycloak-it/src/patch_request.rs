...
//! (`{"schemas": [...], "Operations": [...]}`) into [`little_auth_scim::patch::PatchOperation`]s.
//! little-auth-scim itself deliberately doesn't own this: `PatchOperation` isn't `Deserialize`
...
use little_auth_scim::patch::{PatchOp, PatchOperation};
